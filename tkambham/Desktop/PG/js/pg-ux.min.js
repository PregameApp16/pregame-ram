...
(function(a) {
    ...
    b = function() {
    ...
    }), define("amd/env", ["jquery"], function(a) {
        var b, c = {
        ...
        return {
            getInstance: function() {
                if (!b) {
                    var a = c.areCookiesSupported();
                    b = {
                        areCookiesSupported: a
                    }
                }
                return b
            }
        ...
        var c = {
            ...
            CloseSearchBar: function(b) {
                a(c.HeaderSearchClickElement).removeClass("hide"), a(c.HeaderElement).removeClass("open"), a(c.HeaderSearchBarElement).removeClass("open"), b && a(c.HeaderElement).hasClass("black") && c.FadeBackgroundToBlackLinear(), a(c.HeaderSearchClickElement).removeAttr("aria-hidden").find(".accessible-text").text("Show Search.")
            },
            ...
            CloseDropDown: function(b) {
                b && a(c.HeaderElement).hasClass("black") && c.FadeBackgroundToBlackLinear(), a(c.HeaderElement).removeClass("hover-intent open-dropdown"), a(c.HeaderDropDownClickElement).removeClass("hover-intent"), a(c.HeaderDropDownSectionElement).removeClass("hover-intent"), a(c.HeaderDropDownTitleElement).find(".accessible-text").text("Open Drop Down.")
            },
            GetFirstFeatureHeight: function() {
                var b = a(this.MainContentElement),
                    c = [this.HeroElement, this.CarouselElement, this.GeoModuleElement, this.SubHeaderElement],
                    d = c.join(",");
                return b.find(d).height()
            },
        ...
        return {
            init: function(b) {
                ...
                d.on("scroll", function(b) {
                    ...
                    if (!j) {
                        var k = c.GeoModuleElement + "," + c.CarouselElement + "," + c.HeroElement,
                    ...
                    e.length === 1 && (e.offset().top + e.height() > c.GetFirstFeatureHeight() ? c.FadeBackgroundToBlue() : c.FadeBackgroundToBlackLinear()), i > 0 && o > i ? a(c.LoginButtonElement).addClass("stuck") : i > 0 && o < i && a(c.LoginButtonElement).removeClass("stuck");
                    if (p.is(".open")) {
                ...
                var k = !1,
                    l = function(b) {
                        ...
                        if (d.is(".open-dropdown")) return a(c.HeaderElement).hasClass("black") && c.FadeBackgroundToBlackLinear(), c.CloseDropDown(), k = !1, !1;
                ...
                "ontouchstart" in window ? a(c.HeaderDropDownTitleLinkElement).on("click", l) : (a(c.HeaderDropDownTitleLinkElement).on("click", l), a(c.HeaderDropDownTitleElement).is(":visible") && (a(c.HeaderDropDownTitleElement).hoverIntent(function() {
                    ...
                    a(c.HeaderElement).hasClass("open-dropdown") && (a(c.HeaderElement).hasClass("black") && c.FadeBackgroundToBlackLinear(), c.CloseDropDown(), k = !1)
        ...
        return {
            linkHandler: function(b, c) {
                var d = a(b).closest("a").attr("href"),
                    e;
                b && console.log("%c[Util]", "color: orange;", "linkHandler recieved: " + d), c && console.log("%c[Util]", "color: orange;", "linkHandler parse for: " + c);
                var f = a("<a>", {
                    href: d
                })[0];
                console.log("%c[Util]", "color: orange;", "linkHandler parsing: " + f);
                switch (c) {
                    case "protocol":
                        e = f.protocol;
                        break;
                ...
                return console.log("%c[Util]", "color: orange;", "linkHandler returning: " + e), e
            },
    ...
    function(a) {
    ...
    }), define("amd/browser-message", ["jquery", "platform", "amd/env", "jquery.cookie"], function(a, b, c) {
        var d = {
            cookie: "_unsupportedbrowser",
            dismissButton: ".browser-message__dismiss-btn",
            message: ".browser-message",
            closeMessage: function() {
                a(d.message).removeClass("visible")
            },
            openMessage: function() {
                if (c.getInstance().areCookiesSupported) {
                    var b = a.cookie(d.cookie);
                    (b === null || b === undefined) && a(d.message).addClass("visible")
                }
            }
        };
        return {
            init: function(e, f) {
                ...
                if (!g || g > parseFloat(b.version)) {
                    ...
                    d.openMessage();
                    if (f) {
                        var l = j.find("span").clone();
                        j.find("span").remove(), j.append(l)
                    }
                    j.on("click", function(b) {
                        c.getInstance().areCookiesSupported && a.cookie(d.cookie, !0, {
                            expires: 1,
                            path: "/"
                        }), d.closeMessage(), b.preventDefault()
                    }), h.on("scroll", function(a) {
                        var b = h.scrollTop();
                        b > k ? (d.closeMessage(), k = b) : b <= 0 && (d.openMessage(), k = 0)
                    })
                }
            }
        }
        ...
        var e = {
            ...
            setMessage: function() {
                var b = e.readCookie();
                b === "session" ? (a(e.sessionMessage).addClass("display"), a(e.textMessage).focus()) : b === "logoff" ? (a(e.logoffMessage).addClass("display"), a(e.textMessage).focus()) : a(e.message).fadeOut()
            },
            ...
            browserMessageHeight: function() {
                var b = a(e.browserMessage).height();
                return b || (b = 0), b + "px"
            },
            pushMessageDown: function() {
                a(e.browserMessage).hasClass("visible") && a(e.timeoutMessageWrapper).attr("style", "margin-top: " + e.browserMessageHeight())
            }
        };
        return {
            init: function() {
                ...
                if (g === "logoff") {
                    e.pushMessageDown(), e.setMessage(), a(e.message).fadeIn("slow"), a(e.signIn).fadeOut("slow"), e.deleteCookie(), d.focus(), a(document).on("keydown", function(b) {
                        b.keyCode === 9 ? d.is(":focus") ? (f.focus(), b.preventDefault()) : f.is(":focus") && (d.focus(), b.preventDefault()) : b.keyCode === 32 && f.is(":focus") && (a(e.message).fadeOut(), b.preventDefault())
                    });
                    var h = !0;
                    b.on("scroll click", function() {
                        h && (a(e.message).fadeOut(), a(e.sideMenu).focus(), h = !1)
                    })
                }
            }
        }
        ...
        return d.prototype = {
            init: function(d) {
                ...
                m[0] || (m = f.find(".loginBtn input")), f.find(".field input").bind("keypress", function(a) {
                    ...
                    var l = g.val(),
                        m = h.val(),
                        n = typeof i.val() == "undefined" ? "" : i.val(),
                        o = f.find(".user-remember").prop("checked");
                    return m = m === e.passwordText ? "" : m, e.validateandsetcookie(l, m, n, o, ".chase.com", d, f)
        ...
        return {
            init: function() {
                d.CurrentLanguage = a("html").attr("lang"), a(d.ToggleElement).on("click", function(b) {
    ...
    }), define("amd/signin", ["jquery", "content/conf/appsconfig/clientconfig", "sendMessageClient", "amd/dynamic-page-creation", "amd/persona", "platform", "amd/speedbump", "amd/utils", "amd/env", "jquery.cookie"], function(a, b, c, d, e, f, g, h, i) {
        var j = {
            element: ".signin",
            ...
            initCPO: function() {
                if (!j.cpoSettings.resolved) {
                    ...
                    var a = j.cpoSettings.timeout;
                    b && b.cpoSignInTimeout && (a = b.cpoSignInTimeout);
                    var d = setInterval(function() {
                        if (j.cpoSettings.resolved) clearInterval(d), j.hideClassicSignIn(), window.console && console.log("[CPO] Frame Resolved");
                        else {
                            var a = (new Date).getTime();
                            a > j.cpoSettings.startTime + j.cpoSettings.timeout && (j.cpoSettings.resolved = !0, clearInterval(d), j.hideCPOSignIn(), window.console && console.log("[CPO] Frame Timed Out...Loading Classic"))
                        }
                    }, 100)
                }
            },
            hideClassicSignIn: function() {
                a(j.classicSignInContainer).addClass("hide").removeClass("show").attr("aria-hidden", !0), a(j.cpoSignInContainer).removeAttr("aria-hidden").removeClass("hide").addClass("show"), a(j.cpoSignIn).animate({
                    opacity: 1
                }, j.signInAnimationDuration)
            },
            hideCPOSignIn: function() {
                a(j.cpoSignInContainer).addClass("hide").removeClass("show").attr("aria-hidden", !0), a(j.classicSignInContainer).removeAttr("aria-hidden").removeClass("hide").addClass("show"), a(j.classicSignIn).animate({
                    opacity: 1
                }, j.signInAnimationDuration)
            },
            isCPO: function(c) {
                ...
                if (i.getInstance().areCookiesSupported) {
                    var e = a.cookie(j.cpoCookie);
                    e == "1" && j.isCPOSupportedBrowser() && j.isSignInBoxDisplayed(c) && (d = !0)
                }
                return d
            },
            isCPOSupportedBrowser: function() {
                var a = {
                    ...
                    b, c = !1;
                return j.isSignInDesktopView() && (b = a[f.name], b && b <= parseFloat(f.version) && (c = !0)), c
            },
            ...
            isSignInDesktopView: function() {
                return typeof window.matchMedia == "function" && window.matchMedia("(min-width: 992px)").matches ? !0 : !1
            },
            isSpanish: function() {
                var a = !1;
                if (i.getInstance().areCookiesSupported) {
            ...
            ready: function() {
                window.console && console.log("[CPO] Initialized and Ready."), j.cpoSettings.resolved = !0, c.sendMessage({
                    protocol: "displayEvent",
                    command: "focus"
                })
            },
            setupClassicSignIn: function(b) {
                var c = a(document),
                    d = a(j.checkMark),
                    e = a(j.checkMarkBox),
                    f = a(j.checkMarkLabel);
                c.on("click", function(c) {
                    var d = a(c.target);
                    if (d.is(j.checkMarkLabel) || d.parents(j.checkMarkLabel).length === 1) e.is(":checked") ? (e.prop("checked", !1), b && (e.removeClass("checked"), c.preventDefault()), e.focus(), c.preventDefault()) : (e.prop("checked", !0), b && (e.addClass("checked"), c.preventDefault()), e.focus(), c.preventDefault())
                })
            }
        };
        return {
            init: function(b) {
                a.when(d.getArchetype).then(function(c) {
                    var d = !1;
                    j.isSignInDesktopView() && (j.setupClassicSignIn(b), j.isCPO(c) ? j.initCPO() : j.hideCPOSignIn()), a(window).on("resize", function(a) {
                        j.isSignInDesktopView() && (d || (j.isCPO(c) ? j.initCPO() : j.hideCPOSignIn(), d = !0))
                    })
                })
            }
        }
    }), define("amd/hide", ["jquery"], function(a) {
        var b = {
            ...
            toggleManualHide: function() {
                a(b.mobile + "," + b.tablet + "," + b.desktop).removeClass(b.firefoxOverrideClass);
                var c = window.innerWidth;
                c <= 480 ? a(b.mobile).addClass(b.firefoxOverrideClass) : c >= 481 && c <= 1199 ? a(b.tablet).addClass(b.firefoxOverrideClass) : a(b.desktop).addClass(b.firefoxOverrideClass)
            }
        };
        return {
            init: function(c) {
                c && (b.toggleManualHide(), a(window).on("load resize", function(a) {
                    b.toggleManualHide()
                }))
            }
        }
    ...
    function() {
        ...
        a(function() {
            var b = a("body"),
                ...
                w = !1,
                x = b.hasClass("topic"),
                B = b.hasClass("spanish-interstitial-page");
            a.cookie.raw = !0, y.name.toLowerCase() === "ie" ? parseFloat(y.version) === 8 ? (a("html").addClass("lt-ie9"), w = !0) : parseFloat(y.version) === 9 && a("html").addClass("lt-ie10") : y.name.toLowerCase() === "firefox" && (v = !0), w ? o.init() : (z.SetBodyDataDevice(), a(window).on("resize", function() {
                z.SetBodyDataDevice()
            })), c.init(), d.init(), e.init(w), f.init(v), g.init(w), n.init(A, w), h.init(), k.init(), (j || x) && l.init(w), j && i.init(), t.init(), B ? p.initInterstitial() : p.init(), q.init(), r.init(w), s.init(), u.init(), m.attach(document.body);
            var C = a(".main-content--dropzone");
            C.on("Chase:FeatureAppended", function(b, e) {
                var f = a(e),
                    g = f.children(".topic__wrapper");
                if (g.length > 0) {
                    f.animate({
                        opacity: 1
                    }, 400);
                    var i = g.find(".carousel"),
                        j = g.find(".hero__img"),
                        k = g.find(".mosaic.mosaic-version-b");
                    i.each(function() {
                        c.setupCarousels(a(this))
                    }), k.each(function() {
                        h.checkForImageDownloadBeforeEqualizeHeights(a(this))
                    }), j.each(function() {
                        d.checkForImageDownload(a(this))
                    }), l.lazyInit(w)
                }
            })
        }), a(window).on("load", function(b) {
            a(".main-content__inner").height() < a(window).height() && a(".main-content").css({
                "min-height": "initial"
            })
        })
